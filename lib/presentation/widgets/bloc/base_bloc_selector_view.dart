...
///}
///```
class BaseBlocSelectorView<TData, TSelected> extends StatelessWidget {
  const BaseBlocSelectorView({super.key, required this.selectorCallback, required this.builder});
