...
final class AuthModel extends TokenModel implements EntityModel<TokenModel> {
  ...
  @override
  List<Object?> get props => [token, expirationDate, refreshToken, refreshExpirationDate];
}
